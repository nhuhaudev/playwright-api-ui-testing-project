...
| TC_SEARCH_03 | Search | Search with empty keyword | Products page is opened | 1. Leave search input empty 2. Click search button | Empty | System handles empty input without crashing and displays appropriate result (e.g., all products or no result) | Low |
